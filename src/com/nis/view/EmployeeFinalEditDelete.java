...
public class EmployeeFinalEditDelete extends HttpServlet {
	...
	{
	EmployeeController.deleteRecord(Integer.parseInt(request.getParameter("eid")));	
	}
	else if(btn.equalsIgnoreCase("Edit Picture"))
	{
        ...
        EmployeeController.editPicture(F.filename,Integer.parseInt(request.getParameter("eid")));
